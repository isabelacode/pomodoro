...
export function AboutPomodoro() {
  useEffect(() => {
    document.title = "Entenda a Técnica Pomodoro - Timer Pomodoro";
  }, []);
    ...
    <MainTemplate>
      <Container>
        <GenericHtml>
          ...
          <h2>
            Mas no <strong>Timer Pomodoro</strong> tem um diferencial
          </h2>
          ...
          <h2>Por que usar o Timer Pomodoro?</h2>
          <ul>
